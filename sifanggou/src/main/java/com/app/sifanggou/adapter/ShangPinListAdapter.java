...
public class ShangPinListAdapter extends SetBaseAdapter<CommodityInfoBean> {
    
    public ShangPinListAdapter(Context context, List<CommodityInfoBean> list) {
        super(context, list);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_shangpinlist,null);
