...
public class AddBusinessPartnerHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        String partner_business_code = (String) event.getParamAtIndex(4);
        ...
        String result = HttpUtils.doPost(URLUtils.ADDBUSINESSPARTNER   , map);
