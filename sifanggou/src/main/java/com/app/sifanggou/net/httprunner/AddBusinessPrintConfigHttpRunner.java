...
public class AddBusinessPrintConfigHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        String machine_code = (String) event.getParamAtIndex(4);
        String qr_key = (String) event.getParamAtIndex(5);
        ...
        map.put("qr_key", qr_key);

        String result = HttpUtils.doPost(URLUtils.ADDBUSINESSPRINTCONFIG   , map);
