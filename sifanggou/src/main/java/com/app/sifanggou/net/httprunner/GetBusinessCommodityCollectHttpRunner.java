...
public class GetBusinessCommodityCollectHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        String result = HttpUtils.doPost(URLUtils.GETBUSINESSCOMMODITYCOLLECT, map);
        ...
        GetBusinessCommodityCollectResponseBean param = gson.fromJson(result, GetBusinessCommodityCollectResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
