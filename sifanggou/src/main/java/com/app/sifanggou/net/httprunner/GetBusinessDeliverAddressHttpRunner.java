...
public class GetBusinessDeliverAddressHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        String result = HttpUtils.doPost(URLUtils.GETBUSINESSDELIVERADDRESS, map);
        ...
        GetBusinessDeliverAddressResponseBean param = gson.fromJson(result, GetBusinessDeliverAddressResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
