...
public class GetBusinessInfoByCodeHttpRunner extends HttpRunner {
    @Override
    public void onEventRun(Event event) throws Exception {
        ...
        String result = HttpUtils.doPost(URLUtils.GETBUSINESSINFOBYCODE, map);
        ...
        GetBusinessInfoByCodeResponseBean param = gson.fromJson(result, GetBusinessInfoByCodeResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
