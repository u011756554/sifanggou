...
public class GetBusinessInviteCodeHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        GetBusinessInviteCodeResponseBean param = gson.fromJson(result, GetBusinessInviteCodeResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
