...
public class GetBusinessUrgentSellCommoditHttpRunner extends HttpRunner {
    ...
    public void onEventRun(Event event) throws Exception {
        ...
        String result = HttpUtils.doPost(URLUtils.GETBUSINESSURGENTSELLCOMMODIT, map);
        ...
        GetBusinessUrgentSellCommodityResponseBean param = gson.fromJson(result, GetBusinessUrgentSellCommodityResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
