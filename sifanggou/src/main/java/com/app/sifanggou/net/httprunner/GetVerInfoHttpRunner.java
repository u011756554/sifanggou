...
public class GetVerInfoHttpRunner extends HttpRunner {

    @Override
    public void onEventRun(Event event) throws Exception {
        String result = HttpUtils.doGetString(URLUtils.GETVERINFO);
        ...
        GetVerInfoResponseBean param = gson.fromJson(result, GetVerInfoResponseBean.class);
