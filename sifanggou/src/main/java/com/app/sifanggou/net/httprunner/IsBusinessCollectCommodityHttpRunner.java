...
public class IsBusinessCollectCommodityHttpRunner extends HttpRunner {
    @Override
    public void onEventRun(Event event) throws Exception {
        ...
        String result = HttpUtils.doPost(URLUtils.ISBUSINESSCOLLECTCOMMODITY, map);
        ...
        IsBusinessCollectCommodityResponseBean param = gson.fromJson(result, IsBusinessCollectCommodityResponseBean.class);
        if (param == null) {
            event.setSuccess(false);
            return;
        }
