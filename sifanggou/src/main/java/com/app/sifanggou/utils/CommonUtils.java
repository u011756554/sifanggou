...
public class CommonUtils {
	 ...
	 * @return
	 */
	public static String getSign(String business_code,String mobile,String trans_no,String password) {
		try {
			return EncoderByMd5(business_code+mobile+trans_no+password);
		} catch (Exception e) {
			return business_code+mobile+trans_no;
		}
	}
...
//        bitmap.setPixels(pixels,0,100,0,0,w,h);
	...
	public static String buildTransaction() {
	 ...
	 public static String decodeUnicode(String theString) {    
		...
		public static final String KEY_CZCOUNT = "1";
		public static final String KEY_TXCOUNT = "2";
		public static final String KEY_LGCOUNT = "3";
		public static final String KEY_RGCOUNT = "4";
		public static final String KEY_SQROOMCOUNT = "5";
		public static final String KEY_CZNAMEEVENT = "6";
		public static final String KEY_TXNAMEEVENT = "7";
		public static final String KEY_SQROOMNAMEEVENT = "8";
		public static final String KEY_PAYCOUNTEVENT = "10";
		public static final String KEY_CONTACTCOUNT = "11";	
}
