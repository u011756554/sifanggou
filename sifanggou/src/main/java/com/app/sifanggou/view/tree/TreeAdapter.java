...
public class TreeAdapter extends BaseAdapter{
	...
	public View getView(final int location, View view, ViewGroup viewgroup) {
		...
		if(view == null){
			...
			vi.rlEc = (RelativeLayout) view.findViewById(R.id.rl_ec);
			view.setTag(vi);
		}
		else{
		...
		vi.rlEc.setOnClickListener(new OnClickListener() {
		...
		if(n!=null){
			...
			//显示文本
			if (this.colorType == 1) {
				vi.tv.setTextColor(Color.BLACK);
			} else {
				vi.tv.setTextColor(Color.WHITE);
			}
