package com.app.sifanggou.view.wheelview;
...
public class Common {
    ...
    public static ArrayList buildHourListStart(TimeRange timeRange) {
        ...
        ArrayList hourList = new ArrayList<String>();
    ...
    public static ArrayList buildMinuteListStart(TimeRange timeRange ) {
        ...
        ArrayList minList = new ArrayList<String>();
    ...
    public static ArrayList buildNomalMinuteList() {
        ArrayList minuteList = new ArrayList<String>();
